...
public class Nodehavingsumofchildrenandnodeismax {
	    ...
	    public static TreeNode<Integer> maxSumNode(TreeNode<Integer> root) {
	        ...
	        MaxSumNodeInfo maxSumNodeInfo = maxSumNodeHelper(root);
	        return maxSumNodeInfo.node;
	    }
	    ...
	    private static MaxSumNodeInfo maxSumNodeHelper(TreeNode<Integer> root) {
	        ...
	        MaxSumNodeInfo maxSumNodeInfo = new MaxSumNodeInfo(root, sum);

	        for (TreeNode<Integer> child : root.children) {
	            MaxSumNodeInfo childMaxSumNodeInfo = maxSumNodeHelper(child);
	            if (childMaxSumNodeInfo.sum > maxSumNodeInfo.sum) {
	                maxSumNodeInfo = childMaxSumNodeInfo;
	            }
	        }

	        return maxSumNodeInfo;
	    }

	    static class MaxSumNodeInfo {
